    ...
    <>
      <div className="relative container hidden px-20 lg:mx-auto lg:block lg:grid lg:grid-cols-2 lg:content-between">
        ...
        <div className="py-2">
          <div className="button-icon lg:col-span-1">
            ...
            <a href="https://github.com/ibrahim-borio" target="blank" className="cube">
        ...
        <div className="py-2">
          <div className="button-icon lg:col-span-1">
            ...
            <a
              className="cube"
              href="https://www.linkedin.com/in/ibrahim-borio-197a01400/"
              target="blank"
            >
      ...
      <div className="mx-auto grid grid-cols-4 gap-5 px-15 py-5 lg:hidden">
        ...
        <div className="group relative col-span-1">
          <button>
            <a className="" href="https://github.com/ibrahim-borio" target="blank">
              <img
